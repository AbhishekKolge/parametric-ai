            ...
            >
              {selectedValues.length > 0 ? (
                  ...
                  >
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className="-m-0.5 ml-2 flex h-4 w-4 cursor-pointer items-center justify-center rounded-sm p-0.5 hover:bg-white/20 focus:outline-none focus:ring-1 focus:ring-white/50"
                              onClick={(event) => {
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      ...
                      >
                        {`+ ${
                          selectedValues.length - responsiveSettings.maxCount
                        } ${responsiveSettings.maxCount > 0 ? "more" : ""}`}
                        <XCircle
                          className={cn(
                ...
                <div className="mx-auto flex w-full items-center justify-between">
                  ...
                  <ChevronDown className="mx-2 h-4 cursor-pointer text-muted-foreground opacity-50" />
                </div>
              )}
            </Button>
          </PopoverTrigger>
